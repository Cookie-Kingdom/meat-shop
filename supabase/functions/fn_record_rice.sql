...
begin
  ...
  perform fn_require_two_decimals('p_cooked_received_kg', p_cooked_received_kg);
  perform fn_require_two_decimals('p_raw_purchased_kg', p_raw_purchased_kg);
  perform fn_require_two_decimals('p_cooked_today_kg', p_cooked_today_kg);
  perform fn_require_two_decimals('p_raw_remaining_kg', p_raw_remaining_kg);
  perform fn_require_two_decimals('p_cooked_remaining_kg', p_cooked_remaining_kg);
