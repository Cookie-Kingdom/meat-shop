...
-- after the replay (Finding 12), for an OPEN report only: a CLOSED day under an approved,
-- unexpired unlock is lane C's trigger to admit (Finding 4 amended; lane H PLAN-unlock.md
-- Finding 1).
--
