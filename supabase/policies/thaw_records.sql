...
-- thaw_records's SELECT policy lands when the card that owns its view is written.
--
...
alter table public.thaw_records enable row level security;
revoke all on public.thaw_records from anon, authenticated;
