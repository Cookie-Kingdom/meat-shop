...
-- lot_bags's SELECT policy lands when the card that owns its view is written.
--
...
alter table public.lot_bags enable row level security;
revoke all on public.lot_bags from anon, authenticated;
