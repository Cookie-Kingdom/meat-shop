-- influencer_shipments — RLS posture.
--
...
-- influencer_shipments's SELECT policy lands when the card that owns its view is written.
--
...
revoke all on public.influencer_shipments from anon, authenticated;
