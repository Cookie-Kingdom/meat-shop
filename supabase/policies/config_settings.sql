...
-- config_settings's SELECT policy lands when the card that owns its view is written.
--
...
revoke all on public.config_settings from anon, authenticated;
