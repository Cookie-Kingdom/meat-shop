...
-- packaging_items's SELECT policy lands when the card that owns its view is written.
--
...
revoke all on public.packaging_items from anon, authenticated;
