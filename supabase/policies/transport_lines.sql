...
-- transport_lines's SELECT policy lands when the card that owns its view is written.
--
...
revoke all on public.transport_lines from anon, authenticated;
